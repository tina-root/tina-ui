...
module.exports = {
  ...
  systemName: 'TinaRoot',         //系统名称
  copyright: 'TinaRoot.CN ALL',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'http://tinaroot.cn', name: 'TinaRoot'},
    {link: 'http://tinaroot.cn', icon: 'github'},
    {link: 'http://tinaroot.cn', name: '3121831267@qq.com'}
  ],
}
