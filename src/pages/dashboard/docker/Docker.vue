  ...
  <div class="analysis">
    <a-row style="margin-top: 0" :gutter="[24, 24]">
      <a-col :sm="24" :md="12" :xl="6">
        <chart-card :loading="loading" title="容器" :total="imagesNum">
          <a-tooltip title="容器个数" slot="action">
            <a-icon type="info-circle-o"/>
          </a-tooltip>
          <div>
            <trend style="margin-right: 16px" term="上周新增" :percent="12" :is-increase="true" :scale="0"/>
            <trend term="本周新增" :target="100" :value="89" :scale="0"/>
          </div>
          <div slot="footer">每天增长<span> {{imagesNum}}</span></div>
        </chart-card>
      </a-col>
    ...
    <a-row style="margin: 0 -12px">
      <a-col style="padding: 0 12px" :xl="12" :lg="24" :md="24" :sm="24" :xs="24">
        <a-card :loading="loading" :bordered="false" style="margin-top: 24px" title="容器">
          <Images/>
        </a-card>
      </a-col>
      <a-col style="padding: 0 12px" :xl="12" :lg="24" :md="24" :sm="24" :xs="24">
...
export default {
  ...
  components: {Trend, Images,RankingList, Bar, MiniProgress, MiniBar, MiniArea, ChartCard}
}
</script>
